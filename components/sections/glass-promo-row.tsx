...
const TILES = [
  {
    icon: Tag,
    title: "عروض اليوم",
    desc: "تخفيضات على الأكل، الرمل، الألعاب وجميع مستلزمات الحيوانات",
  ...
  },
  {
    icon: Gift,
    title: "هدايا ومفاجآت",
    desc: "عروض موسمية ومفاجآت للحيوانات الأليفة — تابع الجديد من الرئيسية",
  ...
  },
  {
    icon: Sparkles,
    title: "وصل حديثاً",
    desc: "أحدث المنتجات والماركات والأوزان لكل أنواع الحيوانات الأليفة",
