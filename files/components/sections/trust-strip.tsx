...
const ITEMS = [
  {
    icon: Truck,
    title: "توصيل موثوق",
    desc: "طلبات العناية بالأطفال حتى باب منزلك بسرعة",
  },
  {
    icon: ShieldCheck,
    title: "دفع آمن",
    desc: "تسوق بثقة لمنتجات أطفالك",
  },
  {
    icon: Headphones,
    title: "دعم يهتم",
    desc: "فريق جاهز لمساعدتك في اختيار الأنسب لعمر طفلك",
  },
] as const;
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-10 md:py-14">
        <header className="mb-8 text-center md:mb-10">
          ...
          <p className="mx-auto mt-2 max-w-lg text-sm leading-relaxed text-muted-foreground md:text-[15px]">
            نرافقك من الطلب حتى الاستلام — توصيل آمن، دفع موثوق، وفريق يهتم بتفاصيل احتياج طفلك.
          </p>
        </header>
